...
public class GiantKillerEnchantment extends Enchantment {
    ...
    GiantKillerEnchantment(int level) {
        super(level);
    }
    ...
    public String getDescription() {
        return "Increases damage dealt by 0.1% per level for each percent of extra health that your target has above you, up to 25%.";
    }
