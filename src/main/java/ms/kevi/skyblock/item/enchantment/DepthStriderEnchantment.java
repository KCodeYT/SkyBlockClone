...
public class DepthStriderEnchantment extends Enchantment {
    ...
    DepthStriderEnchantment(int level) {
        super(level);
    }
    ...
    public String getDescription() {
        return "Increases horizontal movement speed in water by 33% per level. At level III, the movement speed is the same as on land.";
    }
