...
public class WitherImpactAbility implements IAbility {
    ...
    public String getDescription() {
        return "§7Teleport §a10 blocks §7ahead of you. Then implode dealing §c17,215.7 §7damage to nearby enemies. Also applies the wither shield scroll ability reducing damage taken and granting an absorption shield for §e5 §7seconds.";
    }
    ...
    public boolean onInteract(PlayerInteractEvent event) {
        ...
        for(int i = 0; i < 5; i++)
            player.getLevel().addParticleEffect(pos, ParticleEffect.HUGE_EXPLOSION_LEVEL);
        return true;
    }
