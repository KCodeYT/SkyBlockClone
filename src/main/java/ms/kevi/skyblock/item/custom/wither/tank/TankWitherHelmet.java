...
package ms.kevi.skyblock.item.custom.wither.tank;
...
public class TankWitherHelmet extends AbstractGameItem implements WitherArmor {
    ...
    public PieceItem getHelmet() {
        return (PieceItem) GameItemRegistry.TANK_WITHER_HELMET;
    }

    @Override
    public PieceItem getChestplate() {
        return (PieceItem) GameItemRegistry.TANK_WITHER_CHESTPLATE;
    }

    @Override
    public PieceItem getLeggings() {
        return (PieceItem) GameItemRegistry.TANK_WITHER_LEGGINGS;
    }

    @Override
    public PieceItem getBoots() {
        return (PieceItem) GameItemRegistry.TANK_WITHER_BOOTS;
    }

    @Override
    public CompoundTag getCompoundTag() {
        return new CompoundTag().putCompound("SkullOwner", SkullOwner.buildTag(
                "7b5eba12-eea5-3b0f-968b-cf8578bee45b",
                ""
        ));
    }
