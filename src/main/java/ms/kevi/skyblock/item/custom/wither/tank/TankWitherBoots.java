...
public class TankWitherBoots extends AbstractGameItem implements WitherArmor {
    ...
    public StatsBooster getStatsBooster() {
        return StatsBooster.create().
                put(GameStats.HEALTH, 190).
                put(GameStats.DEFENSE, 165).
