...
public class PowerWitherLeggings extends AbstractGameItem implements WitherArmor {
    ...
    public StatsBooster getStatsBooster() {
        return StatsBooster.create().
                ...
                put(GameStats.HEALTH, 230).
                put(GameStats.DEFENSE, 125).
