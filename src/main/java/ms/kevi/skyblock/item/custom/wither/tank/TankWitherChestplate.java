...
public class TankWitherChestplate extends AbstractGameItem implements WitherArmor {
    ...
    public StatsBooster getStatsBooster() {
        return StatsBooster.create().
                put(GameStats.HEALTH, 310).
                put(GameStats.DEFENSE, 275).
                put(GameStats.INTELLIGENCE, 20);
    }
