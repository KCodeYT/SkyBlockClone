...
public class PowerWitherChestplate extends AbstractGameItem implements WitherArmor {
    ...
    public StatsBooster getStatsBooster() {
        return StatsBooster.create().
                ...
                put(GameStats.HEALTH, 260).
                put(GameStats.DEFENSE, 140).
