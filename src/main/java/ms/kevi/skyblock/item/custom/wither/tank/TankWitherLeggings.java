...
public class TankWitherLeggings extends AbstractGameItem implements WitherArmor {
    ...
    public StatsBooster getStatsBooster() {
        return StatsBooster.create().
                put(GameStats.HEALTH, 250).
                put(GameStats.DEFENSE, 220).
