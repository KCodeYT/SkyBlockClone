...
public class LapisType implements IMinionType {
    ...
    public boolean checkBreakability(Block block) {
        return block.getId() == Block.LAPIS_ORE;
    }
    ...
    public void placeBlock(Block block) {
        block.getLevel().setBlock(block, Block.get(Block.LAPIS_ORE));
    }

    @Override
    public Item getItemInHand(Block block) {
        if(block == null || block.getId() == Block.LAPIS_ORE)
            return Item.get(Item.IRON_PICKAXE, 0, 1);
        return Item.get(Block.LAPIS_ORE, 0, 1);
    }

    @Override
    public Item getChestplateItem() {
        return ((ItemColorArmor) Item.get(Item.LEATHER_TUNIC)).setColor(BlockColor.BLUE_BLOCK_COLOR);
    }

    @Override
    public Item getLeggingsItem() {
        return ((ItemColorArmor) Item.get(Item.LEATHER_PANTS)).setColor(BlockColor.BLUE_BLOCK_COLOR);
    }

    @Override
    public Item getBootsItem() {
        return ((ItemColorArmor) Item.get(Item.LEATHER_BOOTS)).setColor(BlockColor.BLUE_BLOCK_COLOR);
    }
    ...
    public Item getBlockFormat() {
        return Item.get(Item.LAPIS_BLOCK);
    }

    @Override
    public Item getItemFormat() {
        return Item.get(Item.DYE, 4);
    }
